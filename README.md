...
## Documentation
### The model
The prot_gap_model.ipynb is a step by step demonstration of how to train an amino acid classifier on a small set (for convenience) of PDB protein structures (N=250).
